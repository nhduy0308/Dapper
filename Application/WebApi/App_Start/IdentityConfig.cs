...
namespace WebAPI.App_Start
{
    ...
    public class ApplicationRoleManager : RoleManager<AspNetRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AspNetRole>(context.Get<DbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AspNetUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AspNetUser>(context.Get<DbContext>()));
